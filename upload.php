<?php 
include "../../config.php";
require_once __DIR__ .'../../../library/flash.php';
require_once __DIR__ . '../../../library/function.php';
require_once __DIR__ .'../../../library/image-creation.php';
...
const UPLOAD_DIR = __DIR__ . '../../cars/uploads';

$is_post_request = strtolower($_SERVER['REQUEST_METHOD']) === 'post';
$has_file = isset($_FILES['carImg']);
