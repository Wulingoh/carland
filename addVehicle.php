        ...
        <div class="col" style="padding-left: 50px;border-left:1.5px solid #E2E8F0;">
          ...
          <form method="POST" action="" enctype="multipart/form-data">
            ...
            <div class="row">
              ...
              <div class="form-group col-5">
                <span class="openModelWrapper">
                  <button type="button" class="btn" id="openModel" name="addNewColorModal" data-toggle="modal" data-target="#addNewColor" data-whatever="@addNewModel" style="background-color: #2B6777;color:white;">Add New Color</button>
                </span>
              </div>
            </div>
            <br>
