        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            <div class="row container-favourite-row mt-5">
                ...
                <div class="col mt-5 mb-3 ml-3">
                    ...
                    <p class="favourite-texts"><?php echo $row['car_subtitle']; ?></p>
                ...
                <div class="col mt-5 mb-3 ml-3">
                    <input type="button" value="View this car" class="btn btn-outline-success btn-block mb-3" onclick="window.location.href='productDetail.php?carID=<?php echo $row['car_ID']; ?>'">
                    <input type="button" value="Book for test drive" class="btn btn-outline-success btn-block mt-3 mb-2" onclick="window.location.href='contact.php?carId=<?php echo $row['car_ID']?>'">
                    <a href="javascript:" type="button" value="Remove favourite" class="btn btn-outline-secondary btn-block mt-3 mb-2 favouriteHeartBtn" data-carid="<?php echo $row['car_ID'] ?>">Remove favourite
                    </a>
                </div>
            </div>
            <?php
