...
<body>
    ...
    <div class="container-fluid p-0">
        ...
        <div class="container container-about-title-wrapper mb-4">
            <h3 class="text-center font-weight-bolder mb-4" id="ourStory">About Us</h3>
            ...
            <div class="row">
                <div class="col about-texts-left-wrapper">
                    ...
                    <ul class="list-about-value text-justify text-decoration-none ml-5 mr-5">
                        ...
                        <li id="ourValue"><strong>Data driven - data</strong> is part of our DNA and drives all decision making. We're informed, results-driven and seek insights to help us improve and grow.</li>
