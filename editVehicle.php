                 ...
                 <form method="POST" enctype="multipart/form-data" >
                    ...
                    <div class="row">
                      <div class="form-group col-10"> 
                        <select id="make" name="make" class="form-control">
                          ...
                          ?>
                          <option value="<?php echo $make_id; ?>" <?php if($rowID['make_id'] == $make_id): ?> selected <?php endif; ?>><?php echo $make; ?></option>
                          <?php 
                          }
                          ?>
                        </select>
                    ...
                    <div class="row">
                      <div class="form-group col-10">
                        ...
                        <option value="<?php echo $model_id; ?>" <?php if($rowID['model_id'] == $model_id): ?> selected <?php endif; ?>><?php echo $model; ?></option>
                        </select>  
                      </div>
                    ...
                    <div class="row">
                      ...
                      <div class="form-check form-check-inline form-group col-2 ">
                        <input class="form-check-input" type="radio" name="category" id="category<?php echo $category_id; ?>" value="<?php echo $category_id; ?>" <?php if($rowID['category_id']  == $category_id) echo 'checked'?>>
                    ...
                    <div class="row">
                      ...
                      <?php 
                          ...
                          ?>
                      <div class="form-check form-check-inline form-group col-2 ">
                        <input class="form-check-input" type="radio" name="transmission" id="transmission<?php echo $transmission_id; ?>" value="<?php echo $transmission_id; ?>"  <?php if($rowID['transmission_id'] ==  $transmission_id) echo 'checked';?>>
                      ...
                      <div class="form-group col-10">
                        <select class="form-control" name="bodytype" id="bodytype">
                          ...
                          while($rowBodytype = mysqli_fetch_array($resultBodytype)){
                            extract($rowBodytype);
                          ?>
                          <option value="<?php echo $bodytype_id; ?>" <?php if($rowID['bodytype_id'] == $bodytype_id): ?> selected <?php endif; ?> ><?php echo $bodytype; ?></option>
                          <?php 
                          } 
                          ?> 
                        </select>
                      ...
                      <div class="form-group col-10">
                        <select class="form-control" name="seats" id="seats">
                          ...
                          while($rowSeats = mysqli_fetch_array($resultSeats)){
                            extract($rowSeats);
                          ?>
                          <option value="<?php echo $seats_id; ?>" <?php if($rowID['seats_id'] == $seats_id): ?> selected <?php endif; ?>><?php echo $seats; ?></option>
                          <?php 
                          } 
                          ?> 
                        </select>
                      ...
                      <div class="form-group col-10">
                        <select class="form-control" name="fueltype" id="fueltype">
                          ...
                          while($rowFueltype = mysqli_fetch_array($resultFueltype)){
                            extract($rowFueltype);
                          ?>
                          <option value="<?php echo $fueltype_id; ?>" <?php if($rowID['fueltype_id'] == $fueltype_id): ?> selected <?php endif; ?> ><?php echo $fueltype; ?></option>
                          <?php 
                          } 
                          ?> 
                        </select>
                      ...
                      <div class="form-group col-10">
                        <select class="form-control" name="safety" id="safety">
                          ...
                          while($rowSafety = mysqli_fetch_array($resultSafety)){
                            extract($rowSafety);
                          ?>
                          <option value="<?php echo $safety_id; ?>" <?php if($rowID['safety_id'] == $safety_id): ?> selected <?php endif; ?>><?php echo $safety; ?></option>
                          <?php 
                          } 
                          ?> 
                        </select>
