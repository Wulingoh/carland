...
if (isset($_POST['updateCar'])) {
  ...
  if ($_FILES['img']['tmp_name'] != "") {
    ...
    $query = "UPDATE vehicles SET img='$newName', price='$price', year='$year', mileage='$mileage',engine_size='$engine_size', stock='$stock', title='$title', subtitle='$subtitle', detail='$detail',rego='$rego', category_id='$category_id', bodytype_id='$bodytype_id', fueltype_id='$fueltype_id',make_id='$make_id', model_id='$model_id', transmission_id='$transmission_id', color_id='$color_id',seats_id='$seats_id', safety_id='$safety_id',location_id='$location_id' WHERE vehicle_id = '$id' ";
    mysqli_query($link, $query);
  } else {
    $query = "UPDATE vehicles SET price='$price',year='$year',mileage='$mileage',engine_size='$engine_size',stock='$stock', title='$title', subtitle='$subtitle', detail='$detail',rego='$rego',category_id='$category_id',bodytype_id='$bodytype_id',fueltype_id='$fueltype_id',make_id='$make_id',model_id='$model_id',transmission_id='$transmission_id',color_id='$color_id',seats_id='$seats_id',safety_id='$safety_id',location_id='$location_id' WHERE vehicle_id = '$id' ";
    mysqli_query($link, $query);
  }
      ...
      <div class="row">
        ...
        <div class="col" style="padding-left: 50px;border-left:1.5px solid #E2E8F0;">
          ...
          <form method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
              <div class="form-group col-10">
                <input type="text" class="form-control" id="title" name="title" placeholder="Please Enter The Title" value="<?php echo $title; ?>">
              </div>
            </div>
            <br>
            <div class="row">
              <div class="form-group col-10">
                <input type="text" class="form-control" id="subtitle" name="subtitle" placeholder="Please Enter The Subtitle" value="<?php echo $subtitle;  ?>">
              </div>
            </div>
            <br>
