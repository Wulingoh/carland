...
function arrowChange2(){
 ...
 function deleteImg(car_id, img_id) {
      if (confirm("Are you sure you want to delete this image?")) {
        window.location.href = "deleteGallery.php?carID=" + car_id + "&imgID=" + img_id;
      }
    }
      ...
      <div class="container" >
         ...
         <div class="row">
             ...
             <div class="col" style="padding-left: 50px;border-left:2px solid #E2E8F0;">
                 ...
                 <div class="row">
                     <img src="../cars/uploads/<?php  echo $img; ?>" class="img-fluid" width="500px" />
                 </div>
                 <hr>
                 <div class="row">
                 ...
                 <div class="row" id="displayImg">
                     ...
                     ?>
                     <div class="col-4">
                         <img src="../cars/uploads/<?php echo $gallery_img ;?>" width="200">
                         <p>
                            <div class="row">
                              <div class="col-6">
