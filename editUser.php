...
if(isset($_POST['editUser'])){
    ...
    $query = "UPDATE customers SET user_Email='$email', user_Name='$name', user_Password='$password', user_Role='$role' WHERE user_ID='$id' ";
...
$sqlRole = "SELECT * FROM user_role WHERE user_Role = '$roleID'";
...
<div class="adminSection">
    ...
    <div class="row ">
       <div class="col" style="text-align: center;">
         <h2 style="color:cadetblue;">Edit a customer</h2>
       </div>
     </div>
     <br>
     <form method="POST">
       ...
       <div class="form-floating">
         <input type="email" class="form-control" name="userEmail" placeholder="name@example.com" value="<?php echo $email ;?>">
       ...
       <div class="col col-lg-4">
       <div class="form-floating">
         <input type="name" class="form-control" name="userName" value="<?php echo $name ;?>">
       ...
       <div class="row justify-content-md-center">
         <div class="col col-lg-4">
           <button type="submit" class="btn" name="editUser" style="background: cadetblue;color:white;">Update</button>
