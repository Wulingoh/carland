...
if (isset($_POST['addGallery'])) {
    $galleryCap = mysqli_real_escape_string($link, $_POST['galleryCap']);
    ...
    $query = "INSERT INTO gallery (car_ID, gallery_Img, gallery_Cap) VALUES ('$id', '$newName', '$galleryCap' )";
    ...
    <div >
     <div class="row justify-content-md-center ">
       <div class="col-lg-3" style="text-align: center;">
         <h2 style="color:cadetblue;">Add Gallery</h2>
     ...
     <div class="row justify-content-md-center">
        <div class="col col-lg-4">
             ...
             <label for="galleryCap" class="form-label">Add Image Caption</label>
             <input type="text" name="galleryCap" class="form-control">
      ...
      <div class="row justify-content-md-center">
        <div class="col col-lg-4">
             ...
             <label for="carImg" class="form-label">Add Gallery Images</label>
      ...
      <div class="row ">
         <div class="col" style="text-align: center;">
           <button type="submit" class="btn" name="addGallery" style="background: cadetblue;color:white;">Add Image</button>
